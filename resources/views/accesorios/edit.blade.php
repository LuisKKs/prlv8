...
<div class="container">
    <div class="card bg-dark text-light text-center">
        ...
        <form method="POST" action="{{url('acc/'.$acm->id)}}">
            {{ csrf_field() }}
            @method('PATCH')
            @csrf
            <input type="hidden" name="_method" value="PATCH">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
            <input type="text" hidden name="id" value="{{ $acm->id }}">
            <div class=" card-body">
                ...
                <input type="text" id="nota" name="nota" value="{{$acm['nota']}}" class=" form-control form-inline bg-dark text-light text-center" required>
                <label for="marca">Marca:</label>
                <input type="text" id="marca" name="marca_acc" value="{{$acm['marca_acc']}}" class=" form-control form-inline bg-dark text-light text-center" required>
                <label for="modelo">Modelo:</label>
                <input type="text" id="modelo" name="modelo_acc" value="{{$acm['modelo_acc']}}" class=" form-control form-inline bg-dark text-light text-center" required>
            </div>
                    {{ csrf_field() }}
